...
public class LinkRepositoryTest {
  ...
  @Test
  public void delete_shouldUpdateIsActiveToFalse() {
    ...
    Link inactiveLink = this.entityManager.persistFlushFind(linkRepository.findByShortUrl(SHORT_URL));
    assertThat(inactiveLink.getIsActive()).isEqualTo(false);
  }
